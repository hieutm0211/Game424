...
public class GamePlay_7 extends Activity {
    ...
    public void onBackPressed() {
        ...
        setContentView(R.layout.gameplay_level_7);
        initView();
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (background_int==100 && !Computer.isWin(buttons_gamePlay)){
                                intent = new Intent(GamePlay_7.this,GameOver.class);

                                intent.putExtra("level",7);
                                intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                                GamePlay_7.this.finish();
                                GamePlay_7.this.startActivity(intent);
                            }
                        }
                    });
                    try {
            ...
            vir_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Computer.isWin(buttons_gamePlay)) {
                        intent = new Intent(GamePlay_7.this,WinGame.class);
                        intent.putExtra("level",7);
                        intent.putExtra("nextlevel",8);
                        intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                        GamePlay_7.this.finish();
                        GamePlay_7.this.startActivity(intent);
                    }
