...
public class GamePlay_5 extends Activity {
    ...
    private void initView() {
...

        {
            ...
            buttons_default.add(btn_30);
            buttons_default.add(btn_31);
            buttons_default.add(btn_32);
            buttons_default.add(btn_33);
            buttons_default.add(btn_34);
            buttons_default.add(btn_35);
            buttons_default.add(btn_36);
            buttons_default.add(btn_37);
            buttons_default.add(btn_38);
            buttons_default.add(btn_39);
    ...
    protected void onCreate(final Bundle savedstate) {
        ...
        setContentView(R.layout.gameplay_level_5);
        initView();

        Computer.setValueForButtons(buttons_default,20,7,20);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (background_int==100 && !Computer.isWin(buttons_gamePlay)){
                                intent = new Intent(GamePlay_5.this,GameOver.class);

                                intent.putExtra("level",5);
                                intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                                GamePlay_5.this.finish();
                                GamePlay_5.this.startActivity(intent);
                            }
                        }
                    });
                    try {
            ...
            vir_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Computer.isWin(buttons_gamePlay)) {
                        intent = new Intent(GamePlay_5.this,WinGame.class);
                        intent.putExtra("level",5);
                        intent.putExtra("nextlevel",6);
                        intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                        GamePlay_5.this.finish();
                        GamePlay_5.this.startActivity(intent);
                    }
    ...
    private void handleEachButton(Button vir_btn){
        ...
        if (find_lucky==0){
            ...
            int valueOfLuck =rd.nextInt(2);





            if (Computer.calculate_lucky(buttons_touched,tv_score,Integer.parseInt(tv_specialNumber.getText().toString()),valueOfLuck,background_int)&&buttons_touched.size()<=range){
