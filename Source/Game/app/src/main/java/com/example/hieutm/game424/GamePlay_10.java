...
public class GamePlay_10 extends Activity {
    ...
    private void initView() {
        ...
        setContentView(R.layout.gameplay_level_10);
        initView();
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (background_int==100 && !Computer.isWin(buttons_gamePlay)){
                                intent = new Intent(GamePlay_10.this,GameOver.class);

                                intent.putExtra("level",10);
                                intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                                GamePlay_10.this.finish();
                                GamePlay_10.this.startActivity(intent);
                            }
                        }
                    });
                    try {
            ...
            vir_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Computer.isWin(buttons_gamePlay)) {
                        intent = new Intent(GamePlay_10.this,WinGame.class);
                        intent.putExtra("level",10);
