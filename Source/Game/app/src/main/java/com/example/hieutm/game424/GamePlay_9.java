...
public class GamePlay_9 extends Activity {
    ...
    public void onBackPressed() {
        ...
        setContentView(R.layout.gameplay_level_9);
        initView();
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (background_int==100 && !Computer.isWin(buttons_gamePlay)){
                                intent = new Intent(GamePlay_9.this,GameOver.class);

                                intent.putExtra("level",9);
                                intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                                GamePlay_9.this.finish();
                                GamePlay_9.this.startActivity(intent);
                            }
                        }
                    });
                    try {
            ...
            vir_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Computer.isWin(buttons_gamePlay)) {
                        intent = new Intent(GamePlay_9.this,WinGame.class);
                        intent.putExtra("level",9);
                        intent.putExtra("nextlevel",10);
                        intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                        GamePlay_9.this.finish();
                        GamePlay_9.this.startActivity(intent);
                    }
