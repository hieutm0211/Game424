...
public class GamePlay_4 extends Activity {
    ...
    protected void onCreate(final Bundle savedstate) {
        ...
        setContentView(R.layout.gameplay_level_4);
        initView();

        Computer.setValueForButtons(buttons_default,15);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (background_int==100 && !Computer.isWin(buttons_gamePlay)){
                                intent = new Intent(GamePlay_4.this,GameOver.class);

                                intent.putExtra("level",4);
                                intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                                GamePlay_4.this.finish();
                                GamePlay_4.this.startActivity(intent);
                            }
                        }
                    });
                    try {
            ...
            vir_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Computer.isWin(buttons_gamePlay)) {
                        intent = new Intent(GamePlay_4.this,WinGame.class);
                        intent.putExtra("level",4);
