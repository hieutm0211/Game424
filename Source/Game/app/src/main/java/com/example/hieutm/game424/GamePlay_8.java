...
public class GamePlay_8 extends Activity {
    ...
    public void onBackPressed() {
        ...
        setContentView(R.layout.gameplay_level_8);
        initView();
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (background_int==100 && !Computer.isWin(buttons_gamePlay)){
                                intent = new Intent(GamePlay_8.this,GameOver.class);

                                intent.putExtra("level",8);
                                intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                                GamePlay_8.this.finish();
                                GamePlay_8.this.startActivity(intent);
                            }
                        }
                    });
                    try {
            ...
            vir_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Computer.isWin(buttons_gamePlay)) {
                        intent = new Intent(GamePlay_8.this,WinGame.class);
                        intent.putExtra("level",8);
                        intent.putExtra("nextlevel",9);
                        intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                        GamePlay_8.this.finish();
                        GamePlay_8.this.startActivity(intent);
                    }
