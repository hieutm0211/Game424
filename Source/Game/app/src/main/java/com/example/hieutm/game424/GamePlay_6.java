...
public class GamePlay_6 extends Activity {
    ...
    public void onBackPressed() {
        ...
        setContentView(R.layout.gameplay_level_6);
        initView();

        Computer.setValueForButtons(buttons_default,20);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (background_int==100 && !Computer.isWin(buttons_gamePlay)){
                                intent = new Intent(GamePlay_6.this,GameOver.class);

                                intent.putExtra("level",6);
                                intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                                GamePlay_6.this.finish();
                                GamePlay_6.this.startActivity(intent);
                            }
                        }
                    });
                    try {
            ...
            vir_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Computer.isWin(buttons_gamePlay)) {
                        intent = new Intent(GamePlay_6.this,WinGame.class);
                        intent.putExtra("level",6);
                        intent.putExtra("nextlevel",7);
                        intent.putExtra("score",Integer.parseInt(tv_score.getText().toString()));
                        GamePlay_6.this.finish();
                        GamePlay_6.this.startActivity(intent);
                    }
