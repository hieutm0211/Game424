...
public class level5 extends Activity {
    ...
    private void initListButton(){
        ...
        buttons_gamePlay.add(btn_25);
        buttons_gamePlay.add(btn_26);
    ...
    private void Game(){
        ...
        //Set random number
        Logic.fSet_RandomNumber(buttons_gamePlay,15);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            if (!isWin()&&progressStatus==100){
                                Intent i = new Intent(level5.this, gameover.class);
                                i.putExtra("currentlevel",5);
        ...
        for (int i=0;i<mButtons_gamePlay.size();i++){
            ...
            Virtualbtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i;
                    if (isWin()){
                        i= new Intent(level5.this, wingame.class);
                        i.putExtra("nextlevel",6);
                        i.putExtra("currentlevel",5);
                        i.putExtra("score",score);
                        level5.this.startActivity(i);
                        level5.this.finish();
